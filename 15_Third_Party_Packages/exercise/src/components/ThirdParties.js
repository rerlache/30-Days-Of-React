    ...
    <div>
      ...
      <div className="thirdpartybox">
        ...
        <div>
          ...
          validator for react that had minimal configuration and felt natural to
          use. It's configuration and usage is similar to the Laravel PHP
        ...
        <Badge color="info" size="sm" href="https://www.npmjs.com/package/simple-react-validator" target="_blank">
