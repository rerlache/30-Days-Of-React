...
function FormComponent() {
  ...
  function handleSubmit(e) {
    ...
    if (validator.allValid()) {
      ...
      console.log(validator.errorMessages.date)
    }
  }
  return (
    <div>
      ...
      <form>
        <CustomInput
          ...
          IsRequired={true}
        />
        {validator.message('firstname', firstName, 'required|min:2|max:50', { className: 'text-danger' })}
        {validator.message('lastname', lastName, 'required|min:2|max:50', { className: 'text-danger' })}
        {validator.message('email', email, 'required|email', { className: 'text-danger' })}
        {validator.message('date', dateOfBirth, 'required|date', { className: 'text-danger' })}
        <CustomInput
          inputtype="text"
          idtext="lastname"
          placetext="Last name"
